...
namespace Server.Envir.Translations
{
    ...
    public class EnglishMessages : StringMessages
    {
        ...
        public override string ADDHG { get; set; } = "Your Hunt Gold {0} Added was successful.";
        ...
        public override string ReferralHGComplete { get; set; } = "One of your referral's has purchased some HuntGold.";
