...
namespace Server.DBModels
{
    ...
    public sealed class GameGoldPayment : DBObject
    {
        ...
        public long HuntGoldAmount
        {
            get { return _HuntGoldAmount; }
            set
            {
                if (_HuntGoldAmount == value) return;

                var oldValue = _HuntGoldAmount;
                _HuntGoldAmount = value;

                OnChanged(oldValue, value, "HuntGoldAmount");
            }
        }
        private long _HuntGoldAmount;
