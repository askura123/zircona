...
namespace Server.Models
{
    public sealed class PlayerObject : MapObject
    {
        ...
        public UserCurrency FP => Character.Account.FPGold2;
        ...
        public override void ProcessNameColour()
        {
            ...
            DateTime date1 = DateTime.Now;
            {
                ...
                {
                    case 1:
                        NameColour = Color.DarkTurquoise;
                        break;
                    case 2:
                    ...
                    case 10:
                        {
                            ...
                            else if (second == 4|| second == 5 || second == 6)
                            {
                                NameColour = Color.DarkMagenta;
                            }
                             else if (second == 7   || second == 8 || second == 9)
                            {
                                NameColour = Color.DarkSlateBlue;
                            }
                            else if (second == 10 || second == 11 || second == 12)
                            {
                                NameColour = Color.DarkViolet;
                            }
                            else if (second == 13 || second == 14 || second == 15)
                            {
                                NameColour = Color.DodgerBlue;
                            }
                            else if (second == 16 || second == 17 || second == 18)
                            {
                                NameColour = Color.Green;
                            }
                            else if (second == 19 || second == 20 || second == 21)
                            {
                                NameColour = Color.DeepSkyBlue;
                            }
                            else if (second == 22 || second == 23 || second == 24)
                            {
                                NameColour = Color.Gold;
                            }
                            else if (second == 25 || second == 26 || second == 27)
                            {
                                NameColour = Color.DarkTurquoise;
                            }
                            else if (second == 28 || second == 29 || second == 30)
                            {
                                NameColour = Color.DarkMagenta;
                            }
                            else if (second == 31 || second == 32 || second == 33)
                            {
                                NameColour = Color.DarkSlateBlue;
                            }
                            else if (second == 34 || second == 35 || second == 36)
                            {
                                NameColour = Color.DarkViolet;
                            }
                            else if (second == 37 || second == 38 || second == 39)
                            {
                                NameColour = Color.DodgerBlue;
                            }
                            else if (second == 40 || second == 41 || second == 42)
                            {
                                NameColour = Color.Green;
                            }
                            else if (second == 43 || second == 44 || second == 45)
                            {
                                NameColour = Color.DeepSkyBlue;
                            }
                            else if (second == 46 || second == 47 || second == 48)
                            {
                                NameColour = Color.Gold;
                            }
                            else if (second == 49 || second == 50 || second == 51)
                            {
                                NameColour = Color.DarkTurquoise;
                            }
                            else if (second == 52 || second == 53 || second == 54)
                            {
                                NameColour = Color.DarkMagenta;
                            }
                            else if (second == 55 || second == 56 || second == 57)
                            {
                                NameColour = Color.LightPink;
                            }
                            break;
        ...
        protected override void OnSpawned()
        {
            ...
            foreach (CastleInfo castle in SEnvir.CastleInfoList.Binding)
            {
                ...
                Enqueue(new S.GuildCastleInfo { Index = castle.Index, Owner = ownerGuild?.GuildName ?? System.String.Empty, ObserverPacket = false });
            }
        ...
        public void SetUpObserver(SConnection con)
        {
            ...
            foreach (CastleInfo castle in SEnvir.CastleInfoList.Binding)
            {
                ...
                con.Enqueue(new S.GuildCastleInfo { Index = castle.Index, Owner = ownerGuild?.GuildName ?? System.String.Empty });
            }
        ...
        public void GainExperience(decimal amount, bool huntGold, int gainLevel = Int32.MaxValue, bool rateEffected = true,bool Fp=false)
        {
            if (rateEffected)
            {
            ...
            */
            ...
            if (Fp) 
            {
                //CurrencyInfo FPCurrency;
                //FPCurrency = Globals.CurrencyInfoList.Binding.First(x => x.Type == CurrencyType.FP);
                Random random = new Random();
                int randomNumber = random.Next(1, 6);
                FP.Amount= FP.Amount + randomNumber;
                Connection.ReceiveChat(string.Format("You gained {0:#,##0.#} Fame Point(s) from a Boss!",randomNumber), MessageType.System);                
                FPChanged();
            }
        ...
        public override void RefreshStats()
        {
            ...
            Stats[Stat.DropRate] += 10 * Stats[Stat.Rebirth];
            Stats[Stat.GoldRate] += 10 * Stats[Stat.Rebirth];
        ...
        public bool CanUseItem(UserItem item)
        {
            ...
            switch (item.Info.RequiredType)
            {
                case RequiredType.Level:
                    ...
                    break;
                case RequiredType.FamePoints:
                    if (CurrentFP < item.Info.RequiredAmountFP) return false;
                    break;
        ...
        public void FPChanged()
        {
            Enqueue(new S.CurrencyChanged { CurrencyIndex = FP.Info.Index, Amount = FP.Amount });
        }
        ...
        public override void Die()
        {
            ...
            //    //userCurrency.Amount = 4;
            //    //GameScene.Game.InventoryBox.FPLabel.Text += userCurrency.Amount.ToString("#,##0");
        ...
        {
            Character.FiltersClass = System.String.Join(",", p.FilterClass);
            Character.FiltersRarity = System.String.Join(",", p.FilterRarity);
            Character.FiltersItemType = System.String.Join(",", p.FilterItemType);
