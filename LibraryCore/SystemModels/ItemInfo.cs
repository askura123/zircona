...
namespace Library.SystemModels
{
    public class ItemInfo : DBObject
    {
        ...
        public int RequiredAmountFP
        {
            get { return _RequiredAmountFP; }
            set
            {
                if (_RequiredAmountFP == value) return;

                var oldValue = _RequiredAmountFP;
               _RequiredAmountFP = value;

                OnChanged(oldValue, value, "RequiredAmountFP");
            }
        }
        private int _RequiredAmountFP;
        public int Shape
        {
            get { return _Shape; }
            set
